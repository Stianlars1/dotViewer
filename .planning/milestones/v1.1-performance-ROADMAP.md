...
Key tasks:
- Add .plist → xml mapping to LanguageDetector.extensionMap
...
|-------|------|-------|------------|--------|
| P1 | Diagnostics & Profiling | 1 | - | Not started |
| P2 | Quick Wins | 1 | P1 | Not started |
| P3 | Persistent Cache | 2 | P2 | Not started |
| P4 | Highlighter Evaluation | 2 | P3 | Not started |
