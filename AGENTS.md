...
### Analytics scrub and consent banner (2026-09-23, branch `feat/consent-banner`, not live yet)
...
- Verified: 50 site tests, typecheck, `next build`; local end to end against a throwaway Postgres (spec, Verification); branch preview built. Pending: the owner's OK on the preview, then `002` on production, the GA variable for Production before the build, fast-forward `main`, verify live (HANDOFF.md).
