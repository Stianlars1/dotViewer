...
### Settings window redesign (2026-09-22, unreleased)
...
- Fixed from the hands-on check: sidebar at 140 pt and window at 900 × 532 (`.toolbar(removing:)` must precede the column width; the Settings scene needs `.defaultSize`), pinned by `SettingsWindowLayoutTests`. Found, not fixed: "Interface text size" never worked on macOS (KI-020).
- Details: `docs/plans/2026-09-22-settings-window-design.md` and `-plan.md`. Pending: KI-020 decision, merge/PR, #31 confirmation on macOS 15.
