...
public struct PreviewCacheKey: Hashable, Sendable {
    ...
    public init(
        ...
        rawKey = [
            ...
            PreviewFontFamily.sanitized(codeFontFamilyName, fallback: PreviewFontFamily.defaultCodeFamily),
            ...
            PreviewFontFamily.sanitized(markdownRenderedFontFamilyName, fallback: PreviewFontFamily.defaultMarkdownRenderedFamily),
