...
struct MarkdownSettingsView: View {
    @State private var selectedMarkdownTab: String = "markdownPreviewSection"
    ...
    @ViewBuilder
    private var markdownPreviewSection: some View {
    ...
    @ViewBuilder
    private var renderedViewSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Rendered View")
                .font(.headline)
